...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-1a51baed-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-1a51baed-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-1a51baed-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-1a51baed-light.svg">
    <img src="./assets/hero/agent-console-1a51baed-dark.svg" alt="Maulana Rizwan Ahmad - Software Engineer • AI & Games" width="100%">
  </picture>
</p>
